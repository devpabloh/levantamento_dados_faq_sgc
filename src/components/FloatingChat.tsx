...
export default function FloatingChat() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-6 right-6 z-50 h-28 w-28 overflow-hidden rounded-full bg-indigo-600 shadow-lg hover:bg-indigo-800 hover:cursor-pointer"
        ...
        <div className="fixed bottom-35 right-18 z-50 w-[92vw] max-w-md">
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-indigo-500 shadow-2xl">
            <div className="flex items-center justify-between border-b px-4 py-3">
              <h3 className="text-sm font-semibold text-white-800 ">Júlia a sua assistente virtual do SGC</h3>
              <button
